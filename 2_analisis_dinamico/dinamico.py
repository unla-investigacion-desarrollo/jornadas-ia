...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Error: Debes ingresar una pregunta entre comillas. Por ejemplo:")
        print("python3 2_analisis_dinamico/dinamico.py \"Dame un resumen de los participantes\"")
    else:
        pregunta_del_usuario = sys.argv[1]
        nombre_del_excel = "asistencias.xlsx"
        informe = analizar_asistencia_dinamico(nombre_del_excel, pregunta_del_usuario)
        print("\n------------------\n")
